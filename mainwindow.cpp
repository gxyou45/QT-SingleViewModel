...
//%%%%%%%%%%%%%%%%%%
void MainWindow::on_actionChooseOrigin_triggered()
{
    svmView->chooseOrigin();
}

void MainWindow::on_actionChooseXRef_triggered()
{
    svmView->chooseXRef();
}

void MainWindow::on_actionChooseYRef_triggered()
{
    svmView->chooseYRef();
}

void MainWindow::on_actionChooseZRef_triggered()
{
    svmView->chooseZRef();
}
...
void MainWindow::on_actionXY_Plane_triggered()
{
    svmView->calHxy();
}

void MainWindow::on_actionXZ_Plane_triggered()
{
    svmView->calHxz();
}

void MainWindow::on_actionYZ_Plane_triggered()
{
    svmView->calHyz();
}

void MainWindow::on_actionShowPlane_triggered()
{
    svmView->calH();
